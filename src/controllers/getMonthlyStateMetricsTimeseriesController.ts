...
import { getMonthlyStateMetricsTimeseries } from "../services/getMonthlyStateMetricsTimeseries";

export const getMonthlyStateMetricsTimeseriesController = async (
    req: Request,
    res: Response
): Promise<void> => {
    try {
        ...
        const result = await getMonthlyStateMetricsTimeseries(
            state.toUpperCase()
        );
